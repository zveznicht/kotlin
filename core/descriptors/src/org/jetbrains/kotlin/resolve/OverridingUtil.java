...
public class OverridingUtil {
    ...
    private Pair<NewKotlinTypeCheckerImpl, ClassicTypeCheckerContext> createTypeChecker(
        ...
        return new Pair<NewKotlinTypeCheckerImpl, ClassicTypeCheckerContext>(
                new NewKotlinTypeCheckerImpl(kotlinTypeRefiner),
                new ClassicTypeCheckerContext(true, true, true, kotlinTypeRefiner) {
                    @Override
