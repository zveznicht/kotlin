...
private class CapturedArguments(val capturedArguments: List<TypeProjection>, private val originalType: KotlinType) {
    fun isSuitableForType(type: KotlinType): Boolean {
        val areArgumentsMatched = type.arguments.withIndex().all { (i, t) ->
            originalType.arguments.size > i && t == originalType.arguments[i]
        }
        ...
        return areConstructorsMatched && areArgumentsMatched
    }
}
