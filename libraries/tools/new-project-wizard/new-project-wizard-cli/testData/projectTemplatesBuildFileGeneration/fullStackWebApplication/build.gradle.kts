    ...
    sourceSets {
        ...
        val jsMain by getting {
            dependencies {
                ...
                implementation("org.jetbrains:kotlin-react:16.13.0-pre.109-kotlin-KOTLIN_VERSION")
                implementation("org.jetbrains:kotlin-react-dom:16.13.0-pre.109-kotlin-KOTLIN_VERSION")
