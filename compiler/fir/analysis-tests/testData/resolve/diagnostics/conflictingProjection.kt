...
fun test19(): None<InOuter<Int>.OutIntermediate<<!CONFLICTING_PROJECTION!>in<!> String>.InInner<<!CONFLICTING_PROJECTION!>out<!> Char>>? = null

class Two<T, in K>

fun test20(): Two<InOuter<Int>.OutIntermediate<<!CONFLICTING_PROJECTION!>in<!> String>.InInner<<!CONFLICTING_PROJECTION!>out<!> Char>, <!CONFLICTING_PROJECTION!>out<!> Char>? = null

class Three<in T, K, out G>

fun test21(): Three<<!CONFLICTING_PROJECTION!>out<!> In<<!CONFLICTING_PROJECTION!>out<!> Int>, None<Out<<!CONFLICTING_PROJECTION!>in<!> String>>, <!CONFLICTING_PROJECTION!>in<!> Char>? = null
