...
class KotlinDeserializedJvmSymbolsProvider(
        ...
        return packagePartProvider.findPackageParts(packageFqName.asString()).mapNotNull { partName ->
            ...
            PackagePartsCacheData(
                ...
                FirDeserializationContext.createForPackage(
                    ...
                    JvmBinaryAnnotationDeserializer(session, kotlinJvmBinaryClass, byteContent, this),
    ...
    private fun findAndDeserializeClass(
        ...
        deserializeClassToSymbol(
            ...
            JvmBinaryAnnotationDeserializer(session, kotlinJvmBinaryClass, cachedContent, this),
            kotlinScopeProvider,
