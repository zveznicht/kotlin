...
class JavaSymbolProvider(
    ...
    private fun findClass(
        ...
        content?.let { facade.findClass(JavaClassFinder.Request(classId, previouslyFoundClassFileContent = it.content), searchScope) }
            ?: facade.findClass(classId, searchScope)
