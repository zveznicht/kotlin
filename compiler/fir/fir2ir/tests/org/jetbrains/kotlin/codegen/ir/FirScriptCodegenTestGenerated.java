...
public class FirScriptCodegenTestGenerated extends AbstractFirScriptCodegenTest {
    ...
    public void testAllFilesPresentInScript() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/script"), Pattern.compile("^(.+)\\.kts$"), null, TargetBackend.JVM_IR, true, "oldLanguageVersions");
    }
