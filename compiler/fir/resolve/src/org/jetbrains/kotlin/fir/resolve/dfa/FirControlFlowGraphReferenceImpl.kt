...
class FirControlFlowGraphReferenceImpl(
    ...
    val dataFlowGraph: DataFlowGraph? = null
...
class DataFlowGraph(val variableStorage: VariableStorage, val flowOnNodes: Map<CFGNode<*>, Flow>)
...
val FirControlFlowGraphReference.dataFlowGraph: DataFlowGraph?
    get() = (this as? FirControlFlowGraphReferenceImpl)?.dataFlowGraph