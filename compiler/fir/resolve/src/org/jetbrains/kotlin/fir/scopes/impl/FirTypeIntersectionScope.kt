        ...
        while (allMembersWithScope.isNotEmpty()) {
            ...
            if (extractedOverrides.size > 1) {
                val intersectionOverride = intersectionOverrides.getOrPut(mostSpecific) {
                    val newModality = (mostSpecific.fir as FirMemberDeclaration).modality ?: Modality.ABSTRACT
                    val newVisibility = (mostSpecific.fir as FirMemberDeclaration).visibility
