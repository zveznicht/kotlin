...
object FirErrors {
    ...
    // Try expression
    val CATCH_NOT_THROWABLE by error1<FirSourceElement, PsiElement, ConeKotlinType>()
    val SUBTYPE_IN_CATCH by error2<FirSourceElement, PsiElement, ConeKotlinType, ConeKotlinType>()
