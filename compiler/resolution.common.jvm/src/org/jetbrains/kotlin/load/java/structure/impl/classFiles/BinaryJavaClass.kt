...
class BinaryJavaClass(
    ...
    override fun visitTypeAnnotation(typeRef: Int, typePath: TypePath?, descriptor: String?, visible: Boolean): AnnotationVisitor? {
        if (!context.readTypeUseAnnotationsFromClassFiles || descriptor == null)
            return null
        ...
        return BinaryJavaAnnotation.addAnnotation(targetType, descriptor, context, signatureParser, isFreshlySupportedAnnotation = true)
    }
