...
// Copy from IntelliJ to initialize EMPTY, UNKNOWN and KEY directly without using EmptySubstitutor.getInstance(). This removes
// cycle between PsiSubstitutor initialization and service EmptySubstitutor service registration.
...
public interface PsiSubstitutor {
     ...
     */
    @NotNull
    PsiSubstitutor EMPTY = new EmptySubstitutorImpl();
