...
// TESTCASE NUMBER: 6
fun case_6() {
    <!INAPPLICABLE_CANDIDATE!>checkSubtype<!><Byte>(<!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!>)
    <!INAPPLICABLE_CANDIDATE!>checkSubtype<!><Short>(<!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!>)
    <!INAPPLICABLE_CANDIDATE!>checkSubtype<!><Int>(<!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!>)
    <!INAPPLICABLE_CANDIDATE!>checkSubtype<!><Long>(<!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!>)
    <!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!> <!INAPPLICABLE_CANDIDATE!>checkType<!> { <!NONE_APPLICABLE!>check<!><Byte>() }
    <!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!> <!INAPPLICABLE_CANDIDATE!>checkType<!> { <!NONE_APPLICABLE!>check<!><Short>() }
    <!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!> <!INAPPLICABLE_CANDIDATE!>checkType<!> { <!NONE_APPLICABLE!>check<!><Int>() }
    <!UNRESOLVED_REFERENCE!>-<!><!ILLEGAL_CONST_EXPRESSION!>100000000000000000000000000000000<!> <!INAPPLICABLE_CANDIDATE!>checkType<!> { <!NONE_APPLICABLE!>check<!><Long>() }
}
