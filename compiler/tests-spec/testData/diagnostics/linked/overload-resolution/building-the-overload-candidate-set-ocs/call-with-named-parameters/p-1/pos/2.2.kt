...
class Case1() {
    ...
    fun case1(s: String) {
        s.<!DEBUG_INFO_AS_CALL("fqName: sentence3.Case1.padEnd; typeCall: extension function")!>padEnd(length = 3)<!>
    }
}
...
class Case2() {
    fun String.padEnd(length: Int, padChar: Char = ' '): String = TODO()
    fun case2(s: String) {
        s.<!DEBUG_INFO_AS_CALL("fqName: sentence3.Case2.padEnd; typeCall: extension function")!>padEnd(length = 3)<!>
    }
}
...
class Case3() {
    public fun String.padEnd(length: Int, padChar: Char = ' '): String = TODO()
    fun case3(s: String) {
        s.<!DEBUG_INFO_AS_CALL("fqName: sentence3.Case3.padEnd; typeCall: extension function")!>padEnd(length = 3)<!>
        fun innerFirst(s: String?) {
            fun String.padEnd(length: Int, padChar: Char = ' '): String = TODO()
            s?.<!DEBUG_INFO_AS_CALL("fqName: sentence3.Case3.case3.innerFirst.padEnd; typeCall: extension function")!>padEnd(length = 3)<!>
        }

        fun innerSecond() {
            fun String.padEnd(length: Int, padChar: Char = ' '): String = TODO()
            s.<!DEBUG_INFO_AS_CALL("fqName: sentence3.Case3.case3.innerSecond.padEnd; typeCall: extension function")!>padEnd(length = 3)<!>
        }
        s.<!DEBUG_INFO_AS_CALL("fqName: sentence3.Case3.padEnd; typeCall: extension function")!>padEnd(length = 3)<!>
    }
}
