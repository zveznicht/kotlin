...
class Case1(){
    ...
    fun case1_0() {
        ...
        <!DEBUG_INFO_AS_CALL("fqName: testsCase1.Case1.case1_0.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>

        fun case1_1() {
            fun <T> Case1.emptyArray(): Array<T> = TODO()
            <!DEBUG_INFO_AS_CALL("fqName: testsCase1.Case1.case1_0.case1_1.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>
        }
    }
...
class Case2(){
    ...
    fun case1_0() {
        ...
        <!DEBUG_INFO_AS_CALL("fqName: testsCase2.Case2.case1_0.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>

        fun case1_1() {
            fun <T> Case2.<!EXTENSION_FUNCTION_SHADOWED_BY_MEMBER_PROPERTY_WITH_INVOKE!>emptyArray<!>(): Array<T> = TODO()
            <!DEBUG_INFO_AS_CALL("fqName: testsCase2.Case2.case1_0.case1_1.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>
        }
    }
    ...
    fun case2_0(){
        <!DEBUG_INFO_AS_CALL("fqName: testsCase2.Case2.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>
    }
