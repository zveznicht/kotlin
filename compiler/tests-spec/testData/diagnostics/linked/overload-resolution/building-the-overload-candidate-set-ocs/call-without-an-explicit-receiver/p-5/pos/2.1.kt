...
class Case1(){
    ...
    fun case1() {
        ...
        <!DEBUG_INFO_AS_CALL("fqName: testsCase1.Case1.emptyArray; typeCall: function")!>emptyArray<Int>()<!>
    }
}
// FILE: Lib.kt
...
class Case2(){
    ...
    fun case1() {
        ...
        <!DEBUG_INFO_AS_CALL("fqName: testsCase2.Case2.emptyArray; typeCall: function")!>emptyArray<Int>()<!>
    }
}
class A {
