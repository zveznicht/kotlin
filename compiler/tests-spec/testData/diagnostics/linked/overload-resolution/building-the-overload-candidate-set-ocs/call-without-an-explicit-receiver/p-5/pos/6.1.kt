...
fun case1() {
    <!DEBUG_INFO_AS_CALL("fqName: libPackageCase1.emptyArray; typeCall: function")!>emptyArray<Int>()<!>
}
// FILE: Lib.kt
...
fun case2() {
    <!DEBUG_INFO_AS_CALL("fqName: libPackageCase2.emptyArray; typeCall: function")!>emptyArray<Int>()<!>
}
