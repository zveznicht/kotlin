...
class Case1(){
    ...
    fun case1() {
        <!DEBUG_INFO_AS_CALL("fqName: testsCase1.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>
    }
}
...
class Case2(){
    ...
    fun case1() {
        <!DEBUG_INFO_AS_CALL("fqName: testsCase2.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>
    }
}
class A {
