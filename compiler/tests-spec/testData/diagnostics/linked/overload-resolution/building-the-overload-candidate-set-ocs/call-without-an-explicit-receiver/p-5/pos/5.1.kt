...
fun case1() {
    <!DEBUG_INFO_AS_CALL("fqName: testsCase1.emptyArray; typeCall: function")!>emptyArray<Int>()<!>
}
...
fun case2() {
    <!DEBUG_INFO_AS_CALL("fqName: testsCase2.emptyArray; typeCall: function")!>emptyArray<Int>()<!>
}
