...
class Case1(){
    ...
    fun case1() {
        <!DEBUG_INFO_AS_CALL("fqName: libPackageCase1Explicit.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>
    }
}
...
class Case2(){
    ...
    fun case1() {
        <!DEBUG_INFO_AS_CALL("fqName: libPackageCase2Explicit.emptyArray; typeCall: extension function")!>emptyArray<Int>()<!>
    }
}
