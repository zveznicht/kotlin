 ...
 */
fun case1() {
    val x = <!UNRESOLVED_REFERENCE, UNRESOLVED_REFERENCE!>for (<!SYNTAX!><!>) { }<!>
    val y = for (x in 1..2) { }
 ...
 */
fun case2() {
    var x = <!UNRESOLVED_REFERENCE, UNRESOLVED_REFERENCE!>for (<!SYNTAX!><!>) { }<!>
    var y = for (x in 1..2) { }
...
fun case3() {
    ...
    x = <!UNRESOLVED_REFERENCE, UNRESOLVED_REFERENCE!>for (<!SYNTAX!><!>) { }<!>
    y = for (x in 1..2) { }
