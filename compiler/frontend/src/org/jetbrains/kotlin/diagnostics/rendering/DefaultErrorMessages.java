...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(FUN_INTERFACE_WITH_SUSPEND_FUNCTION, "'suspend' function as a single abstract member is not supported, please use JVM/IR backend (-Xuse-ir) to enable this functionality");
