...
class ResolvedAtomCompleter(
    ...
    private fun updateTraceForLambda(
        ...
        approximatedReceiverType: UnwrappedType?
    ) {
        ...
        if (approximatedReceiverType != null && extensionReceiverParameter is ReceiverParameterDescriptorImpl && extensionReceiverParameter.type.shouldBeSubstituted()) {
            extensionReceiverParameter.setOutType(approximatedReceiverType)
        }
