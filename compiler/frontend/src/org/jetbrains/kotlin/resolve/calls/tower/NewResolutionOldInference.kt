...
class NewResolutionOldInference(
    ...
    public class ImplicitScopeTowerImpl(
        ...
        override fun getContributedFunctionsAndConstructors(
            ...
            return getContributedFunctionsAndConstructors(resolutionContext, resolutionScope, callResolver, candidateInterceptor, name, location)
        }
    }
...
fun ImplicitScopeTower.getContributedFunctionsAndConstructors(
    ...
    resolutionScope: ResolutionScope,
    callResolver: CallResolver?,
    candidateInterceptor: CandidateInterceptor,
    name: Name,
    location: LookupLocation
): Collection<FunctionDescriptor> {
