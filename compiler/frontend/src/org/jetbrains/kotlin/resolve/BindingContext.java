...
import static org.jetbrains.kotlin.util.slicedMap.RewritePolicy.ALWAYS_REWRITE;
...
public interface BindingContext {
     ...
     */
    WritableSlice<KtExpression, Map<String, ExtensionBindingContextData>> EXTENSION_SLICE = new BasicWritableSlice<>(ALWAYS_REWRITE);
