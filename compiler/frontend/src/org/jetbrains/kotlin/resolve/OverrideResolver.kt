        ...
        */
        ...
        private fun isReturnTypeOkForOverride(
            ...
            return if (superDescriptor is PropertyDescriptor && superDescriptor.isVar)
                NewKotlinTypeCheckerImpl(kotlinTypeRefiner).equalTypes(subReturnType, substitutedSuperReturnType)
            else
                NewKotlinTypeCheckerImpl(kotlinTypeRefiner).isSubtypeOf(subReturnType, substitutedSuperReturnType)
        }
