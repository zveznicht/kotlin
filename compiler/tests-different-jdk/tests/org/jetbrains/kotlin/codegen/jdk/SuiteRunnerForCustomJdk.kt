...
class SuiteRunnerForCustomJdk constructor(klass: Class<*>, builder: RunnerBuilder?) :
    ...
    init {
        performFilter(klass, this) f@{ description ->
            val methodAnnotation = description.getAnnotation(TestMetadata::class.java) ?: return@f null
            val testClassAnnotation = description.testClass.getAnnotation(TestMetadata::class.java) ?: return@f null
