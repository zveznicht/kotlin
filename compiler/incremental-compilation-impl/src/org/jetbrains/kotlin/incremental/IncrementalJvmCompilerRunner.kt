...
class IncrementalJvmCompilerRunner(
    ...
    override fun calculateSourcesToCompileImpl(
        ...
        val lastBuildInfo = BuildInfo.read(lastBuildInfoFile) ?: return CompilationMode.Rebuild(RebuildReason.NO_BUILD_HISTORY)
    ...
    private fun processChangedJava(changedFiles: ChangedFiles.Known, caches: IncrementalJvmCachesManager): RebuildReason? {
            ...
            if (!caches.platformCache.isTrackedFile(javaFile)) {
                ...
                for (psiClass in psiFile.classes) {
                    ...
                    if (qualifiedName == null) {
                        ...
                        return RebuildReason.JAVA_CHANGE_UNKNOWN_QUALIFIER
                    }
