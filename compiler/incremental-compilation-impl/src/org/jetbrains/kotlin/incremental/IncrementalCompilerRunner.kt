...
import org.jetbrains.kotlin.build.report.metrics.RebuildReason
...
abstract class IncrementalCompilerRunner<
    ...
    ): ExitCode = reporter.measure(BuildTime.INCREMENTAL_COMPILER) {
    ...
    private fun compileImpl(
        ...
        fun rebuild(reason: RebuildReason): ExitCode {
        ...
        return try {
            ...
            rebuild(RebuildReason.CACHE_CORRUPTION)
        }
    }
    ...
    private fun sourcesToCompile(caches: CacheManager, changedFiles: ChangedFiles, args: Args): CompilationMode =
        when (changedFiles) {
            ...
            is ChangedFiles.Unknown -> CompilationMode.Rebuild(RebuildReason.UNKNOWN_CHANGES_IN_GRADLE_INPUTS)
        }
    ...
    protected sealed class CompilationMode {
        ...
        class Rebuild(val reason: RebuildReason) : CompilationMode()
    }
    ...
    private fun compileIncrementally(
        ...
        val dirtySources = when (compilationMode) {
            ...
            is CompilationMode.Rebuild -> {
                ...
                reporter.reportRebuildReason(compilationMode.reason)
