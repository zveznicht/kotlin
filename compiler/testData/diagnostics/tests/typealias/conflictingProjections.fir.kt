...
fun <T> testOutForInWithinResolvedType(x: <!CONFLICTING_PROJECTION!>InAlias<out T><!>) {}
fun <T> testInForOutWithinResolvedType(x: <!CONFLICTING_PROJECTION!>OutAlias<in T><!>) {}
