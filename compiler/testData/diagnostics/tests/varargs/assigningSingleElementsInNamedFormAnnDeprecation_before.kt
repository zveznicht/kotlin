...
@Ann(s = <!ASSIGNING_SINGLE_ELEMENT_TO_VARARG_IN_NAMED_FORM_ANNOTATION, TYPE_MISMATCH!>"value"<!>)
fun test1() {}
...
@JavaAnn(value = <!ASSIGNING_SINGLE_ELEMENT_TO_VARARG_IN_NAMED_FORM_ANNOTATION, TYPE_MISMATCH!>"value"<!>)
fun test4() {}
