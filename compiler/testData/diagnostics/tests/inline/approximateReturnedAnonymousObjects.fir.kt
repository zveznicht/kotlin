...
fun test3(b: Boolean) {
    var x = <!DEBUG_INFO_EXPRESSION_TYPE("ERROR CLASS: Cannot hide local type object : R|I1|, R|I2| {     private constructor(): R|<anonymous>| {         super<R|kotlin/Any|>()     }      public final fun bar(): R|kotlin/Int| {         ^bar R|<local>/f|.R|FakeOverride<kotlin/Function0.invoke: R|kotlin/Int|>|()     }  } ")!>foo3 { 1 }<!>
    if (b) {
        x = <!DEBUG_INFO_EXPRESSION_TYPE("ERROR CLASS: Cannot hide local type object : R|I1|, R|I2| {     private constructor(): R|<anonymous>| {         super<R|kotlin/Any|>()     }      public final fun bar(): R|kotlin/Int| {         ^bar R|<local>/f|.R|FakeOverride<kotlin/Function0.invoke: R|kotlin/Int|>|()     }  } ")!>foo3 { 2 }<!>
    }
    x.<!UNRESOLVED_REFERENCE!>bar<!>()
}
