...
private fun <!CONFLICTING_OVERLOADS!>invalidFun1<!>() {}
private fun <!CONFLICTING_OVERLOADS!>invalidFun1<!>() {}

private fun <!CONFLICTING_OVERLOADS!>invalidFun2<!>() {}
public fun <!CONFLICTING_OVERLOADS!>invalidFun2<!>() {}

public fun invalidFun3() {}

private fun <!CONFLICTING_OVERLOADS!>invalidFun4<!>() {}
public fun <!CONFLICTING_OVERLOADS!>invalidFun4<!>() {}
