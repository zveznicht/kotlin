...
const val constStr = "Success"
const val concat1 = "String concatenation example: $constStr"
const val concat2 = "String concatenation example with primitive: ${1}"
const val concat3 = "String concatenation example with primitive and explicit toString call: ${1.toString()}"
