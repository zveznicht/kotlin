...
const val result1 = foo()
const val result2 = bar()

const val result3 = checkForArrayList(1)
const val result4 = checkForArrayList(listOf<Int>())
const val result5 = checkForArrayList(arrayListOf<Int>())

const val result6 = checkForArray(1)
const val result7 = checkForArray(intArrayOf())
const val result8 = checkForArray(arrayOf<Int>())
