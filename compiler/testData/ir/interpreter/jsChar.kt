...
const val min = Char.MIN_VALUE
const val max = Char.MAX_VALUE
const val min_high = Char.MIN_HIGH_SURROGATE
const val max_high = Char.MAX_HIGH_SURROGATE
const val min_low = Char.MIN_LOW_SURROGATE
const val max_low = Char.MAX_LOW_SURROGATE
const val min_surrogate = Char.MIN_SURROGATE
const val max_surrogate = Char.MAX_SURROGATE
const val bytes = Char.SIZE_BYTES
const val bits = Char.SIZE_BITS
