...
const val num1 = getClassAsA(1).getStr()
const val num2 = getClassAsB(2).getStr()
const val num3 = getClassAsB(3).getInt()
const val num4 = getClassAsC(4).getStr()
const val num5 = getClassAsC(5).getInt()