// !LANGUAGE: -ReadTypeUseAnnotationsFromClassFiles -ImprovementsAroundTypeEnhancement

package test;

import org.jetbrains.annotations.*;

public class Basic_DisabledImprovementsAndReading<T extends @NotNull Object> {
    ...
    public interface MyClass<TT> {
        ...
        G<Basic_DisabledImprovementsAndReading.@Nullable A.B<?, ?>> f81();
        G<Basic_DisabledImprovementsAndReading.A.@Nullable B<?, ?>> f9();
        <T extends @NotNull Object, K extends G<@NotNull String []>> void f10(T p);
    }

    Basic_DisabledImprovementsAndReading(G<@NotNull String> p) { }
}