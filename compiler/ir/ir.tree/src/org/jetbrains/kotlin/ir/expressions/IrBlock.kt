...
import org.jetbrains.kotlin.ir.util.transformPureToInterface
import org.jetbrains.kotlin.ir.visitors.IrElementTransformer
import org.jetbrains.kotlin.ir.visitors.IrElementVisitor

abstract class IrContainerExpression : IrPureExpression(), IrStatementContainer {
    ...
    override fun <D> transformChildren(transformer: IrElementTransformer<D>, data: D) {
        (statements as MutableList<IrPureElement>?)!!.transformPureToInterface { it.transform(transformer, data) }
    }
}
