...
internal class IrCarrierDeserializerImpl(val declarationDeserializer: IrDeclarationDeserializer) : IrCarrierDeserializer() {
    ...
    override fun deserializeFunction(proto: Long): IrFunctionSymbol {
        return declarationDeserializer.symbolDeserializer.deserializeIrSymbol(proto) as IrFunctionSymbol
    }
