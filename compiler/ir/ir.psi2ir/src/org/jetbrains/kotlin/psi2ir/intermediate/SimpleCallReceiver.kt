...
class SimpleCallReceiver(
    ...
    private val additionalReceiverValues: List<IntermediateValue>
) : CallReceiver {
    ...
    override fun call(withDispatchAndExtensionReceivers: (IntermediateValue?, IntermediateValue?, List<IntermediateValue>) -> IrExpression): IrExpression {
        return withDispatchAndExtensionReceivers(dispatchReceiverValue, extensionReceiverValue, additionalReceiverValues)
    }
}
