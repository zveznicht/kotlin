...
private fun StatementGenerator.generateValueArgumentUsing(
    ...
    when (valueArgument) {
        ...
        is VarargValueArgument ->
            // TODO apply suspend conversion, see KT-38604
...
private fun IrExpression.canBeCapturedDirectlyInSuspendConversion(): Boolean {
    if (this !is IrGetValue) return false
    val declaration = symbol.owner
    return declaration is IrValueParameter || declaration is IrVariable && !declaration.isVar
}
