...
internal fun interpretUnaryFunction(name: String, type: String, a: Any?): Any? {
    when (name) {
        ...
        "toString" -> when (type) {
            ...
            "Any" -> return (a as Any).defaultToString()
        }
        "dec" -> when (type) {
        ...
        "message" -> when (type) {
            "Throwable" -> return (a as ExceptionState).getMessage()
        }
        "cause" -> when (type) {
            "Throwable" -> return (a as ExceptionState).getCause()
        }
    }
    throw InterpreterMethodNotFoundException("Unknown function: $name($type)")
}
...
internal fun interpretBinaryFunction(name: String, typeA: String, typeB: String, a: Any?, b: Any?): Any? {
    ...
    throw InterpreterMethodNotFoundException("Unknown function: $name($typeA, $typeB)")
}
...
internal fun interpretTernaryFunction(name: String, typeA: String, typeB: String, typeC: String, a: Any?, b: Any?, c: Any?): Any {
    ...
    throw InterpreterMethodNotFoundException("Unknown function: $name($typeA, $typeB, $typeC)")
}
