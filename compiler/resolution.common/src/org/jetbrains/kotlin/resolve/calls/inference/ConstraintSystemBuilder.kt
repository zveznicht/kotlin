...
interface ConstraintSystemOperation {
    ...
    fun getBuiltFunctionalExpectedType(expectedType: TypeVariableMarker): KotlinTypeMarker?
    ...
    fun putBuiltFunctionalExpectedType(expectedType: KotlinTypeMarker, newVariable: TypeVariableMarker)
