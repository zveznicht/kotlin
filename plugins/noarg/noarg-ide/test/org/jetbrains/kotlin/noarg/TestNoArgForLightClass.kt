...
class TestNoArgForLightClass : KotlinLightCodeInsightFixtureTestCase() {
    ...
    override fun setUp() {
        ...
        val configurationArgumentsData = facet.configuration.settings.compilerArgumentsData ?: error { "CompilerArgumentsData not found" }

        configurationArgumentsData.pluginClasspaths = arrayOf("SomeClasspath")
        configurationArgumentsData.pluginOptions = arrayOf("$NO_ARG_ANNOTATION_OPTION_PREFIX$noArgAnnotationName")
    }
