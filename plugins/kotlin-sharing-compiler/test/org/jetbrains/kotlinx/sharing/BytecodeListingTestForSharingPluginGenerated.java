...
public class BytecodeListingTestForSharingPluginGenerated extends AbstractBytecodeListingTestForSharingPlugin {
    ...
    public void testAllFilesPresentInCodegen() throws Exception {
        KotlinTestUtils
                .assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("plugins/kotlin-sharing-compiler/testData/codegen"),
