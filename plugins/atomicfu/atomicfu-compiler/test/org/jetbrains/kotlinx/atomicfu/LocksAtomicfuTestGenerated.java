...
public class LocksAtomicfuTestGenerated extends AbstractLocksAtomicfuTest {
    ...
    public void testAllFilesPresentInLocks() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("plugins/atomicfu/atomicfu-compiler/testData/locks"), Pattern.compile("^(.+)\\.kt$"), null, true);
    }
