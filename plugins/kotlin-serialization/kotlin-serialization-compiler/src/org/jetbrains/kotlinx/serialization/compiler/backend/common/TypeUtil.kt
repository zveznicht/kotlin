...
fun AbstractSerialGenerator?.findTypeSerializerOrContextUnchecked(
    ...
    this?.additionalSerializersInScopeOfCurrentFile?.get(kType)?.let { return it }
    if (!kType.isMarkedNullable) {
        this?.additionalSerializersInScopeOfCurrentFile?.get(kType.makeNullable())?.let { return it }
    }
