...
class KaptGradleProjectImportHandler : GradleProjectImportHandler {
    ...
    private fun modifyCompilerArgumentsForPlugin(facet: KotlinFacet) {
        ...
        compilerArgumentsBucket.setMultipleArgument(CommonCompilerArguments::pluginOptions, newPluginOptions.toArrayIfNotEmpty())
        compilerArgumentsBucket.setMultipleArgument(CommonCompilerArguments::pluginClasspaths, newPluginClasspath.toArrayIfNotEmpty())
    }
