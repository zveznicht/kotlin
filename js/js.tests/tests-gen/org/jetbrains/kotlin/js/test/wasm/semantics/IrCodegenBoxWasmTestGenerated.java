    ...
    public static class ExtensionFunctions extends AbstractIrCodegenBoxWasmTest {
        ...
        public static class AdditionalReceiverObjects extends AbstractIrCodegenBoxWasmTest {
            ...
            public void testAllFilesPresentInAdditionalReceiverObjects() throws Exception {
                KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/box/extensionFunctions/additionalReceiverObjects"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.WASM, true);
            }
        ...
        public static class AdditionalReceivers extends AbstractIrCodegenBoxWasmTest {
            ...
            public void testAllFilesPresentInAdditionalReceivers() throws Exception {
                KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/box/extensionFunctions/additionalReceivers"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.WASM, true);
            }
