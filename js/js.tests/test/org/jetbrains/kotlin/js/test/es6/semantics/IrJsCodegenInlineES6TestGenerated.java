...
public class IrJsCodegenInlineES6TestGenerated extends AbstractIrJsCodegenInlineES6Test {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class Tailrec extends AbstractIrJsCodegenInlineES6Test {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS_IR_ES6, testDataFilePath);
        }

        public void testAllFilesPresentInTailrec() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxInline/tailrec"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JS_IR_ES6, true);
        }
        ...
        public static class Suspend extends AbstractIrJsCodegenInlineES6Test {
            ...
            public void testAllFilesPresentInSuspend() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxInline/tailrec/suspend"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JS_IR_ES6, true);
            }
