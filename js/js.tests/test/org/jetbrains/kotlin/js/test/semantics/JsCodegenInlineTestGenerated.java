...
public class JsCodegenInlineTestGenerated extends AbstractJsCodegenInlineTest {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class Tailrec extends AbstractJsCodegenInlineTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS, testDataFilePath);
        }

        public void testAllFilesPresentInTailrec() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxInline/tailrec"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JS, true);
        }
        ...
        public static class Suspend extends AbstractJsCodegenInlineTest {
            ...
            public void testAllFilesPresentInSuspend() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxInline/tailrec/suspend"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JS, true);
            }
