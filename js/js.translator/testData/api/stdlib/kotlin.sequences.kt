...
@kotlin.SinceKotlin(version = "1.4") @kotlin.WasExperimental(markerClass = {kotlin.ExperimentalStdlibApi::class}) public inline fun </*0*/ S, /*1*/ T : S> kotlin.sequences.Sequence<T>.reduceOrNull(/*0*/ operation: (acc: S, T) -> S): S?
...
@kotlin.SinceKotlin(version = "1.4") @kotlin.WasExperimental(markerClass = {kotlin.ExperimentalStdlibApi::class}) public fun </*0*/ S, /*1*/ T : S> kotlin.sequences.Sequence<T>.runningReduce(/*0*/ operation: (acc: S, T) -> S): kotlin.sequences.Sequence<S>
...
@kotlin.SinceKotlin(version = "1.4") @kotlin.WasExperimental(markerClass = {kotlin.ExperimentalStdlibApi::class}) public fun </*0*/ T, /*1*/ R> kotlin.sequences.Sequence<T>.scan(/*0*/ initial: R, /*1*/ operation: (acc: R, T) -> R): kotlin.sequences.Sequence<R>
@kotlin.SinceKotlin(version = "1.4") @kotlin.WasExperimental(markerClass = {kotlin.ExperimentalStdlibApi::class}) public fun </*0*/ T, /*1*/ R> kotlin.sequences.Sequence<T>.scanIndexed(/*0*/ initial: R, /*1*/ operation: (index: kotlin.Int, acc: R, T) -> R): kotlin.sequences.Sequence<R>
@kotlin.Deprecated(level = DeprecationLevel.ERROR, message = "Use runningReduce instead.", replaceWith = kotlin.ReplaceWith(expression = "runningReduce(operation)", imports = {})) @kotlin.SinceKotlin(version = "1.3") @kotlin.ExperimentalStdlibApi public fun </*0*/ S, /*1*/ T : S> kotlin.sequences.Sequence<T>.scanReduce(/*0*/ operation: (acc: S, T) -> S): kotlin.sequences.Sequence<S>
