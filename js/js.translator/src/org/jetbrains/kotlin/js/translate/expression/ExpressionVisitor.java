...
public final class ExpressionVisitor extends TranslatorVisitor<JsNode> {
    ...
    @Override
    @NotNull
    public JsNode visitBlockExpression(@NotNull KtBlockExpression ktBlock, @NotNull TranslationContext context) {
        List<KtExpression> statements = ktBlock.getStatements();
