...
class FirAnalysisSession(
    ...
    override fun getReturnTypeForKtDeclaration(declaration: KtDeclaration): KtType = withValidityAssertion {
        ...
        firDeclaration.returnTypeRef.coneTypeUnsafe<ConeKotlinType>().asTypeInfo()
    }

    override fun getKtExpressionType(expression: KtExpression): KtType = withValidityAssertion {
        expression.getOrBuildFirOfType<FirExpression>().typeRef.coneTypeUnsafe<ConeKotlinType>().asTypeInfo()
    }
