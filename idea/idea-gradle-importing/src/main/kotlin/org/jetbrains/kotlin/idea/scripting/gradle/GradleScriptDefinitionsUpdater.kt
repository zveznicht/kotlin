    ...
    override fun onEnd(id: ExternalSystemTaskId) {
        if (id.type == ExternalSystemTaskType.RESOLVE_PROJECT && id.projectSystemId == GRADLE_SYSTEM_ID) {
            ...
            val gradleDefinitionsContributor =
                project.extensionArea.getExtensionPoint(ScriptDefinitionContributor.EP_NAME).extensions.filterIsInstance<GradleScriptDefinitionsContributor>().firstOrNull()
