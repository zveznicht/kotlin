...
class JavaToKotlinAction : AnAction() {
        ...
        fun convertFiles(
            ...
            fun convert() {
                val converter =
                    ...
                    ) else J2kConverterExtension.extension(ExperimentalFeatures.newJ2k.isEnabled).createJavaToKotlinConverter(
                        project,
                        module,
                        ConverterSettings.defaultSettings,
                        IdeaJavaToKotlinServices
                ...
                converterResult = converter.filesToKotlin(
                    ...
                    else J2kConverterExtension.extension(ExperimentalFeatures.newJ2k.isEnabled).createPostProcessor(formatCode = true),
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (!J2kConverterExtension.extension(ExperimentalFeatures.newJ2k.isEnabled).doCheckBeforeConversion(project, module)) return
