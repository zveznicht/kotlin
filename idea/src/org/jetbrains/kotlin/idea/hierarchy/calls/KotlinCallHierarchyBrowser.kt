...
class KotlinCallHierarchyBrowser(element: PsiElement) : CallHierarchyBrowserBase(element.project, element) {
    ...
    override fun createHierarchyTreeStructure(typeName: String, psiElement: PsiElement): HierarchyTreeStructure? {
        ...
        return when (typeName) {
            CALLER_TYPE -> {
                KotlinCallerTreeStructure(psiElement, currentScopeType)
            }
            CALLEE_TYPE -> {
