    ...
    protected fun doTest(unused: String) {
        ...
        fun checkCall(element: KtElement) {
            ...
            if (styleIdByCall != null && styleIdByCall == styleIdByComment) {
                val highlightInfoWrapper = HighlightInfoWrapper(psiFile)
                val checkers = AbstractKotlinHighlightingPass.getAfterAnalysisVisitor(highlightInfoWrapper, bindingContext)
                ...
                assertTrue(
                    ...
                    highlightInfoWrapper.infos().any {
