...
public class IrKotlinSteppingTestGenerated extends AbstractIrKotlinSteppingTest {
    ...
    public static class StepInto extends AbstractIrKotlinSteppingTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doStepIntoTest, TargetBackend.JVM_IR, testDataFilePath);
        }

        public void testAllFilesPresentInStepInto() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("idea/jvm-debugger/jvm-debugger-test/testData/stepping/stepIntoAndSmartStepInto"), Pattern.compile("^([^.]+)\\.kt$"), null, TargetBackend.JVM_IR, true);
        }
    ...
    public static class SmartStepInto extends AbstractIrKotlinSteppingTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doSmartStepIntoTest, TargetBackend.JVM_IR, testDataFilePath);
        }
    ...
    public static class StepIntoOnly extends AbstractIrKotlinSteppingTest {
        ...
        public void testAllFilesPresentInStepIntoOnly() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("idea/jvm-debugger/jvm-debugger-test/testData/stepping/stepInto"), Pattern.compile("^([^.]+)\\.kt$"), null, TargetBackend.JVM_IR, true);
        }
    ...
    public static class StepOut extends AbstractIrKotlinSteppingTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doStepOutTest, TargetBackend.JVM_IR, testDataFilePath);
        }

        public void testAllFilesPresentInStepOut() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("idea/jvm-debugger/jvm-debugger-test/testData/stepping/stepOut"), Pattern.compile("^([^.]+)\\.kt$"), null, TargetBackend.JVM_IR, true);
        }
    ...
    public static class StepOver extends AbstractIrKotlinSteppingTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doStepOverTest, TargetBackend.JVM_IR, testDataFilePath);
        }

        public void testAllFilesPresentInStepOver() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("idea/jvm-debugger/jvm-debugger-test/testData/stepping/stepOver"), Pattern.compile("^([^.]+)\\.kt$"), null, TargetBackend.JVM_IR, true);
        }
    ...
    public static class Filters extends AbstractIrKotlinSteppingTest {
        ...
        public void testAllFilesPresentInFilters() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("idea/jvm-debugger/jvm-debugger-test/testData/stepping/filters"), Pattern.compile("^([^.]+)\\.kt$"), null, TargetBackend.JVM_IR, true);
        }
    ...
    public static class Custom extends AbstractIrKotlinSteppingTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doCustomTest, TargetBackend.JVM_IR, testDataFilePath);
        }

        public void testAllFilesPresentInCustom() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("idea/jvm-debugger/jvm-debugger-test/testData/stepping/custom"), Pattern.compile("^([^.]+)\\.kt$"), null, TargetBackend.JVM_IR, true);
        }
